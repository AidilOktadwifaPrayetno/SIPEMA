<div class="row">
  <div class="col s12 m9">
    <h3 class="orange-text" style="font-weight: bold;">Pengaduan Baru</h3>
  </div>
</div>
...
<table id="example" class="display responsive-table" style="width:100%">
  ...
  <tbody>
    <?php 
      ...
      WHERE pengaduan.status='KONFIRMASI' 
          ...
          <div class="modal-content">
			...
			<?php 
				if(isset($_POST['tanggapi'])){
					...
					if($query){
						$update=mysqli_query($koneksi,"UPDATE pengaduan SET status='PROSES' WHERE id_pengaduan='".$r['id_pengaduan']."'");
						if($update){
							echo "<script>alert('Pengaduan Sudah di Proses')</script>";
