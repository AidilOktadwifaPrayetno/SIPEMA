<div class="row">
  <div class="col s12 m9">
    <h3 class="orange-text" style="font-weight: bold;">Pengaduan Proses</h3>
  </div>
</div>
          ...
          <div class="modal-content">
	            ...
	            <div class="col s12 m6">
					<form method="POST">
						<div class="col s12 input-field">
							<label for="textarea">Respon Lanjut : </label>
							<textarea id="textarea" name="tanggapan_lanjut" class="materialize-textarea"></textarea>
						</div>
						<div class="col s12 input-field">
			...
			<?php 
				if(isset($_POST['tanggapi'])){
					$tgl = date('Y-m-d');
					$query = mysqli_query($koneksi,"INSERT INTO tanggapan_lanjut VALUES (NULL,'".$r['id_pengaduan']."','".$tgl."','".$_POST['tanggapan_lanjut']."','".$_SESSION['data']['id_petugas']."')");
					if($query){
						$update=mysqli_query($koneksi,"UPDATE pengaduan SET status='SELESAI' WHERE id_pengaduan='".$r['id_pengaduan']."'");
						if($update){
							echo "<script>alert('Pengaduan Sudah Selesai')</script>";
